...
export default function LightIndustrial() {
  ...
  return (
    <div className="w-full bg-[#1a1a2e] text-white pt-24 pb-16 sm:pt-32 lg:pt-36 overflow-hidden">
      ...
      <section
        ref={heroRef}
        className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 sm:mb-24 lg:mb-28 transition-all duration-1000 ease-out"
        style={{
          opacity: heroInView ? 1 : 0,
          transform: heroInView ? 'translateY(0)' : 'translateY(30px)',
        }}
      >
        <div className="w-full max-w-[680px] h-[240px] sm:h-[320px] lg:h-[380px] mx-auto relative rounded-2xl overflow-hidden border border-white/10 bg-white/5 group"
      ...
      <section id="hvac" ref={gridRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24 sm:mb-32">
        ...
        >
          ...
          <h2 id="metric-industrial-hvac-heading" className="font-black text-2xl sm:text-4xl text-white">Industrial HVAC Systems</h2>
        </div>
        ...
        >
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            <div>
              ...
              <h2 id="metric-industrial-elec-heading" className="font-black text-2xl sm:text-4xl text-white">Industrial Electrical Services</h2>
            </div>
        ...
        >
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            <div>
              ...
              <h2 id="metric-industrial-plumb-heading" className="font-black text-2xl sm:text-4xl text-white">Industrial Plumbing & Piping</h2>
            </div>
