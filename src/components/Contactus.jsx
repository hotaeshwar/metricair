    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col gap-16 lg:gap-20">
        ...
        >
          ...
          <h1 id="metric-contact-heading" className="font-black text-3xl sm:text-4xl lg:text-5xl leading-tight mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="flex flex-col gap-6">
              ...
              {/* Address */}
              <a
                href="https://maps.google.com/?q=6355+Kennedy+Rd+%239,+Mississauga,+ON"
                target="_blank"
              ...
              >
                ...
                <span className="text-sm leading-relaxed">6355 Kennedy Rd #9, Mississauga, ON</span>
              </a>
