  ...
  return (
    <div className="w-full bg-[#1a1a2e] text-white pt-24 pb-16 sm:pt-32 lg:pt-36 overflow-hidden">
      ...
      >
        ...
        <h1 id="metric-ind-exhaust-heading" className="font-black leading-tight text-3xl sm:text-5xl lg:text-6xl mb-6">
          <span className="text-[#c3252e]">Industrial Exhaust</span>{' '}
          <span className="text-[#8f8cff]">Ventilation</span>{' '}
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl overflow-hidden group">
              <div className="relative w-full aspect-[16/9] overflow-hidden bg-[#0f0f1a]/50">
                <img 
                  ...
                  alt="Industrial Exhaust Ventilation Systems"
