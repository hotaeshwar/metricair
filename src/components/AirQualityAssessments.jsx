// src/components/AirQualityAssessments.jsx
...
const HIGHLIGHTS = [
  "Certified VOC & Particulate Concentration Tests",
  "Industrial Facility Airflow Exchange Surveys",
  "Local Ministry of Environment EPA Compliance",
  "CO & CO2 Concentration Level Studies",
  "Relative Humidity & Temperature Zoning Checks",
  "Detailed Recommendations & Remediation Engineering"
];

export default function AirQualityAssessments() {
    ...
    <div className="w-full bg-[#1a1a2e] text-white pt-24 pb-16 sm:pt-32 lg:pt-36 overflow-hidden">
      ...
      >
        <span className="text-gray-400 text-xs font-bold uppercase tracking-widest block mb-4">
          Industrial Environmental Testing & Surveys
        </span>
        <h1 id="metric-air-quality-heading" className="font-black leading-tight text-3xl sm:text-5xl lg:text-6xl mb-6">
          <span className="text-[#c3252e]">Air Quality</span>{' '}
          <span className="text-[#8f8cff]">Industrial Assessment</span>{' '}
        ...
        <p className="text-gray-400 text-sm sm:text-base md:text-lg leading-relaxed max-w-3xl mx-auto">
          Identify airborne pollutants, determine air exchange rates, and optimize environmental compliance with certified industrial air quality assessments.
        </p>
      </section>
      ...
      <section ref={gridRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl overflow-hidden group">
              <div className="relative w-full aspect-[16/9] overflow-hidden bg-[#0f0f1a]/50">
                <img 
                  ...
                  alt="Air Quality Testing Surveys"
              ...
              <div className="p-6 sm:p-8">
                <h2 className="text-white font-black text-xl sm:text-2xl mb-4">Comprehensive Facility Testing</h2>
                <p className="text-gray-300 text-sm leading-relaxed mb-6">
                  Poor air exchange rates and particulate accumulation impact occupant health and violate Ministry of Labour or EPA regulations. We utilize calibrated particulate counters and gas sensors to measure VOC, CO, CO2, and humidity levels, providing stamped regulatory reports along with specific remediation HVAC engineering recommendations.
                </p>
          ...
          >
            <h3 className="text-white font-bold text-lg mb-6 uppercase tracking-wider border-b border-white/10 pb-3">Book an Air Quality Assessment</h3>
            <LeadForm
              subject="Air Quality Assessment Inquiry"
              fromName="MetricAir Air Quality"
              buttonText="Book Environmental Survey"
            />
          </div>
