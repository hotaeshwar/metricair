// src/components/WaterHeatersRental.jsx
...
const HIGHLIGHTS = [
  "Zero Upfront Equipment & Installation Cost",
  "Free Lifetime Repairs and Annual Maintenances",
  "High-Efficiency Tankless and Standard Tank Options",
  "24/7 Priority Emergency Support All Over Canada",
  "Affordable Fixed Monthly Rental Pricing Plans",
  "Free Upgrades for Old and Outdated Units"
];

export default function WaterHeatersRental() {
    ...
    <div className="w-full bg-[#1a1a2e] text-white pt-24 pb-16 sm:pt-32 lg:pt-36 overflow-hidden">
      ...
      >
        <span className="text-gray-400 text-xs font-bold uppercase tracking-widest block mb-4">
          Hassle-Free Hot Water Programs
        </span>
        <h1 id="metric-water-heaters-rental-heading" className="font-black leading-tight text-3xl sm:text-5xl lg:text-6xl mb-6">
          <span className="text-[#c3252e]">Water Heaters</span>{' '}
        ...
        <p className="text-gray-400 text-sm sm:text-base md:text-lg leading-relaxed max-w-3xl mx-auto">
          Rent premium, energy-efficient water heaters with zero upfront capital, free installations, and lifetime maintenance support.
        </p>
      </section>
      ...
      <section ref={gridRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
          ...
          >
            <div className="bg-white/5 border border-white/10 rounded-3xl overflow-hidden group">
              <div className="relative w-full aspect-[16/9] overflow-hidden bg-[#0f0f1a]/50">
                <img 
                  src="/images/water_heater_rental_ai.png"
                  alt="Worry-Free Hot Water System Rentals"
              ...
              <div className="p-6 sm:p-8">
                <h2 className="text-white font-black text-xl sm:text-2xl mb-4">Worry-Free Hot Water Service</h2>
                <p className="text-gray-300 text-sm leading-relaxed mb-6">
                  Why buy a costly water heater when you can rent one with complete protection? Our comprehensive rental program covers all installation charges, replacement components, and support runs. You pay a low, predictable monthly rate while enjoying modern, high-recovery heating systems.
                </p>
          ...
          >
            <h3 className="text-white font-bold text-lg mb-6 uppercase tracking-wider border-b border-white/10 pb-3">Apply For Rental Program</h3>

            <LeadForm
              subject="Water Heater Rental Inquiry"
