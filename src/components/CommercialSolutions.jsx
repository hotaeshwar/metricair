    ...
    <div className="w-full bg-[#1a1a2e] text-white pt-24 pb-16 sm:pt-32 lg:pt-36 overflow-hidden">
      ...
      <section id="hvac" ref={gridRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24 sm:mb-32">
        ...
        >
          ...
          <h2 className="font-black text-2xl sm:text-4xl text-white">Commercial HVAC & Ventilation</h2>
        </div>
        ...
        >
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            <div>
              ...
              <h2 className="font-black text-2xl sm:text-4xl text-white">Commercial Electrical Services</h2>
            </div>
        ...
        >
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            <div>
              ...
              <h2 className="font-black text-2xl sm:text-4xl text-white">Commercial Plumbing & Piping</h2>
            </div>
