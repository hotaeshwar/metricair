// src/components/CompleteConstructionPackage.jsx
...
const HIGHLIGHTS = [
  "Commercial Kitchen Hood & Exhaust Installation",
  "Gas Piping & Appliance Connections",
  "Complete HVAC Ducting & Air Balancing",
  "Plumbing & Grease Trap Installations",
  "Certified Building Permit Stamped Drawings",
  "ESA Electrical Inspections & Compliance"
];

export default function CompleteConstructionPackage() {
    ...
    <div className="w-full bg-[#1a1a2e] text-white pt-24 pb-16 sm:pt-32 lg:pt-36 overflow-hidden">
      ...
      >
        <span className="text-gray-400 text-xs font-bold uppercase tracking-widest block mb-4">
          Turnkey Kitchen & Restaurant Fit-Outs
        </span>
        <h1 id="metric-complete-construction-heading" className="font-black leading-tight text-3xl sm:text-5xl lg:text-6xl mb-6">
          <span className="text-[#c3252e]">Complete Construction</span>{' '}
          <span className="text-[#8f8cff]">Restaurant</span>{' '}
        ...
        <p className="text-gray-400 text-sm sm:text-base md:text-lg leading-relaxed max-w-3xl mx-auto">
          We provide a complete turnkey mechanical construction package for restaurants and commercial kitchens, covering layout drawings, permit submissions, gas piping, exhaust hoods, grease traps, and full HVAC installations.
        </p>
      </section>
          ...
          >
            <div className="bg-white/5 border border-white/10 rounded-3xl overflow-hidden group">
              ...
              <div className="p-6 sm:p-8">
                <h2 className="text-white font-black text-xl sm:text-2xl mb-4">One Contractor. Complete Turnkey Solutions.</h2>
                <p className="text-gray-300 text-sm leading-relaxed mb-6">
                  Coordinating multiple mechanical contractors for a restaurant fit-out leads to delays, communication gaps, and cost overruns. Our specialized commercial kitchen construction package provides complete end-to-end service, ensuring municipal building compliance, structural compliance, and prompt approvals.
                </p>
