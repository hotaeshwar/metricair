...
export default function Footer() {
  ...
  return (
    <footer className="w-full footer-bg text-white relative overflow-hidden rounded-t-[40px]">
      {/* Subtle top accent line */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#c3252e] to-transparent opacity-60" />
          ...
          <div className="lg:col-span-3 flex flex-col gap-4 text-center md:text-left">
            <a href="/" className="block">
              <img
                ...
                alt="MetricAir Logo"
                className="w-60 sm:w-72 lg:w-88 h-auto object-contain mx-auto md:mx-0"
              />
            </a>
            <p className="text-gray-300 text-xs leading-relaxed tracking-wide font-medium max-w-sm">
              {t("Delivering premium HVAC solutions for homes, businesses, and industrial spaces across Canada.")}
            </p>

            <div className="flex flex-col gap-2 text-[11px] text-gray-400 mt-1 border-t border-white/5 pt-3 max-w-sm">
