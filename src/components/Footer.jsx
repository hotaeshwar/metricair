      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-8">
          ...
          <div className="flex flex-col gap-5 lg:w-[230px] xl:w-[250px] shrink-0">
            ...
            {/* Nav links – Home, Contact Us, About Us */}
            <nav className="flex flex-col gap-2.5">
              {navLinks.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className="text-gray-400 text-sm hover:text-[#e94560] transition-colors duration-150"
                >
                  {link.label}
                </a>
              ))}
              ...
              <div key={ci} className="flex flex-col gap-8">
                {col.groups.map((group) => (
                  <div key={group.heading}>
                    <h4 className="text-[#e94560] text-xs font-bold tracking-widest uppercase mb-3">
                      {group.heading}
                    </h4>
                      ...
                      <ul className="flex flex-col gap-2">
                        {group.links.map((link) => (
                          <li key={link}>
                            <a
                              href="#"
                              className="text-gray-400 text-sm hover:text-[#e94560] transition-colors duration-150 leading-snug"
                            >
                              {link}
                            </a>
                          </li>
          ...
          {/* ── Far right: sign in, social, legal ── */}
          <div className="flex flex-col gap-6 lg:w-[140px] xl:w-[160px] shrink-0 lg:items-end">
            {/* Sign In / Feedback */}
            <div className="flex flex-col gap-2 lg:items-end">
              <a href="#" className="text-gray-400 text-sm hover:text-[#e94560] transition-colors duration-150">
                Sign In
              </a>
              <a href="#" className="text-gray-400 text-sm hover:text-[#e94560] transition-colors duration-150">
                Feedback
            ...
            <div className="flex items-center gap-3">
              <a href="#" className="text-gray-400 hover:text-[#e94560] transition-colors duration-150">
            ...
            <div className="flex flex-col gap-1 lg:items-end">
              <a href="#" className="text-gray-500 text-xs font-semibold hover:text-[#e94560] transition-colors duration-150">
                Privacy Policy
              </a>
              <a href="#" className="text-gray-500 text-xs font-semibold hover:text-[#e94560] transition-colors duration-150">
                Warranty Policy
