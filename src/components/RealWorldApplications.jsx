        ...
        <div className="px-6 sm:px-8 py-6">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <p className="text-gray-600 text-xs text-center">No spam. No obligation. We respect your privacy.</p>
            </form>
          )}
        </div>
      </div>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['Heating', 'Cooling', 'Ventilation', 'Commercial Kitchen', 'Industrial', 'Rentals', 'Other'].map((t) => (
                    <button
                      type="button"
                      key={t}
              ...
              <p className="text-gray-600 text-xs text-center">Free consultation. No commitment required.</p>
            </form>
          )}
        </div>
      </div>
