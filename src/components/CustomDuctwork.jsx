// src/components/CustomDuctwork.jsx
...
const HIGHLIGHTS = [
  "Rectangular Sheet Metal Duct Fabrication",
  "Custom Furnace Plenums and Transitions",
  "Heavy Gauge Galvanized and Stainless Steel",
  "Quick Turnaround for Active Construction Jobs",
  "Custom Elbows, Offsets, and Specialty Fittings",
  "Detailed Duct Design Drawings Accompanied"
];

export default function CustomDuctwork() {
  ...
  return (
    <div className="w-full bg-[#1a1a2e] text-white pt-24 pb-16 sm:pt-32 lg:pt-36 overflow-hidden">
      ...
      >
        ...
        <h1 id="metric-custom-ductwork-heading" className="font-black leading-tight text-3xl sm:text-5xl lg:text-6xl mb-6">
      ...
      <section ref={gridRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
          ...
          >
            <div className="bg-white/5 border border-white/10 rounded-3xl overflow-hidden group">
              <div className="relative w-full aspect-[16/9] overflow-hidden bg-[#0f0f1a]/50">
                <img 
                  src="/images/custom_ductwork_ai.png"
                  alt="Custom Ductwork Sheet Metal Fabrication"
              ...
              <div className="p-6 sm:p-8">
                <h2 className="text-white font-black text-xl sm:text-2xl mb-4">Precision Metal Fabrication</h2>
                <p className="text-gray-300 text-sm leading-relaxed mb-6">
                  Our sheet metal manufacturing facility is equipped with automated shears, benders, and rollers to construct ductwork matching residential and commercial floor plans. We handle complex transition designs, custom off-sets, plenums, and elbows in-house to bypass logistics delays.
                </p>
          ...
          >
            <h3 className="text-white font-bold text-lg mb-6 uppercase tracking-wider border-b border-white/10 pb-3">Request a Fabrication Quote</h3>

            <LeadForm
              subject="Custom Ductwork Fabrication Inquiry"
              fromName="MetricAir Ductwork"
              buttonText="Request Metal Shop Quote"
            />
          </div>
