  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        {product.badge && !["Best Seller", "Value Pack", "Popular", "Essential", "New", "Smart Home"].includes(product.badge) && (
          <span id="metric-store-badge" className="metric-store-badge-txt absolute top-3 left-3 px-2.5 py-1 rounded-full bg-[#c3252e] text-white text-xs font-bold uppercase tracking-wider shadow-lg">
            {product.badge}
          </span>
        )}
        {product.stock === 0 && (
...
export default function Store() {
  ...
  try {
    ...
    return (
      <section id="metric-store-section" className="w-full bg-[#1a1a2e] text-white pt-28 pb-20 sm:pt-32 sm:pb-24 lg:pt-36 lg:pb-32 px-4 sm:px-8 lg:px-16 overflow-hidden min-h-screen">
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-12 lg:gap-16">
          ...
          >
            ...
            <h1 id="metric-store-heading" className="font-black leading-tight text-4xl sm:text-5xl lg:text-6xl mb-5">
