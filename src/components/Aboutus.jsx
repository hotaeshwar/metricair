...
const VALUES = [
  ...
  },
  {
    ...
    desc: "HVAC failures shouldn't cause financial panic. Our Worry-Free Rental programs offer zero upfront costs, zero parts or maintenance fees, and lifetime priority support runs all over Canada.",
    icon: (
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-20 lg:gap-28">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          >
            ...
            <h2 id="metric-about-heading" className="font-black leading-tight text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
            ...
            >
              ...
              <StatCard value="Canada"  suffix=""  label="All Over Canada"    started={statsInView} />
            </div>
          </div>
